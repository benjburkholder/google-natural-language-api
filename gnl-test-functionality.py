        ...
        if choice == 'E' or choice == 'e':
            with open('gnl-direct-check.txt', 'r') as gnl:
                ...
                def syntax_text(text):
                    ...
                    pos_tag = (
                    'UNKNOWN', 'ADJ', 'ADP', 'ADV', 'CONJ', 'DET', 'NOUN', 'NUM', 'PRON', 'PRT', 'PUNCT', 'VERB', 'X',
                    'AFFIX')
...
if decision == 'bulk':
    while True:
        ...
        # ------------------------Start Working Area----------------------------------------------
            ...
            """
            Trying to get the program to scrape and collect all p tags together, then run as a singular string.
            So far, I think the spacing of the content scraped is causing GNL analysis to fail for certain URLs. Need
            to find a way to effectively clean up the scraped p tags automatically.
            """
